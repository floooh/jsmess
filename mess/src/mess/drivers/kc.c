...
static INPUT_PORTS_START( kc85 )
	...
	PORT_BIT(0x10, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("Clr") 				PORT_CODE(KEYCODE_F10) PORT_CHAR(8)
...
//	PORT_BIT(0x10, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("Del") 				PORT_CODE(KEYCODE_F10) PORT_CHAR(UCHAR_MAMEKEY(DEL))
	PORT_BIT(0x10, IP_ACTIVE_HIGH, IPT_KEYBOARD) PORT_NAME("Del") PORT_CODE(KEYCODE_F11) PORT_CHAR(UCHAR_MAMEKEY(DEL))
...
static MACHINE_CONFIG_START( kc85_3, kc_state )
	...
	/* devices */
	MCFG_QUICKLOAD_ADD("quickload", kc, "kcc", 10)
